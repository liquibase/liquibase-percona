...
assert buildLogText.contains("Executing: pt-online-schema-change --alter-foreign-keys-method=auto --nocheck-unique-key-change --alter=\"ADD CONSTRAINT fk_person_parent FOREIGN KEY (parent) REFERENCES _person_new (id)\" --password=*** --execute h=${config_host},P=${config_port},u=${config_user},D=${config_dbname},t=person");
