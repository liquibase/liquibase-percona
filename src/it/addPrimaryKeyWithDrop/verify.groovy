...
assert buildLogText.contains("Executing: pt-online-schema-change --alter-foreign-keys-method=auto --no-check-unique-key-change --no-check-alter --alter=\"DROP PRIMARY KEY, ADD PRIMARY KEY (id, name)\" --password=*** --execute h=${config_host},P=${config_port},u=${config_user},D=${config_dbname},t=person")
