...
assert buildLogText.contains("Executing: pt-online-schema-change --alter=\"ADD COLUMN testColumn BIGINT NULL, ADD CONSTRAINT fk_test_column FOREIGN KEY (testColumn) REFERENCES test_parent(id)\"")
...
assert buildLogText.contains("Executing: pt-online-schema-change --alter=\"ADD COLUMN testColumn2 BIGINT NULL, ADD CONSTRAINT uc_test_column UNIQUE (testColumn2)\"")
...
assert buildLogText.contains("Executing: pt-online-schema-change --alter=\"ADD COLUMN testColumn3 BIGINT NULL, ADD CONSTRAINT fk_test_column3 FOREIGN KEY (testColumn3) REFERENCES test_parent(id), ADD CONSTRAINT uc_test_column3 UNIQUE (testColumn3)\"")
...
assert buildLogText.contains("Executing: pt-online-schema-change --alter=\"ADD COLUMN testColumn4 BIGINT NULL, ADD CONSTRAINT fk_test_column4 FOREIGN KEY (testColumn4) REFERENCES test_parent(id)\"")
