...
assert buildLogText.contains("Executing: pt-online-schema-change --alter-foreign-keys-method=auto --nocheck-unique-key-change --alter=\"ADD PRIMARY KEY (id)\" --password=*** --execute h=${config_host},P=${config_port},u=${config_user},D=${config_dbname},t=person")
