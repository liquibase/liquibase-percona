...
assert buildLogText.contains("Executing: pt-online-schema-change --alter=\"ADD CONSTRAINT uq_id_name UNIQUE (id, name)\" --alter-foreign-keys-method=auto --nocheck-unique-key-change --host=127.0.0.1 --port=${config_port} --user=${config_user} --password=*** --execute D=${config_dbname},t=person");
