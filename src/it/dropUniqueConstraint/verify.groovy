...
assert buildLogText.contains("test-changelog.xml::3::Alice: Executing: pt-online-schema-change --alter=\"DROP KEY uq_id_name\" --alter-foreign-keys-method=auto --host=127.0.0.1 --port=${config_port} --user=${config_user} --password=*** --execute D=${config_dbname},t=person");
