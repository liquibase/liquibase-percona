...
assert !buildLogText.contains("Executing: pt-online-schema-change --alter=\"ADD UNIQUE INDEX emailIdx (email)\" --alter-foreign-keys-method=auto --nocheck-unique-key-change --password=*** --execute h=${config_host},P=${config_port},u=${config_user},D=testdb,t=person")
