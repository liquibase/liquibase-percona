...
assert buildLogText.contains("Executing: pt-online-schema-change --alter=\"DROP INDEX emailIdx\" --alter-foreign-keys-method=auto --nocheck-unique-key-change --host=${config_host} --port=${config_port} --user=${config_user} --password=*** --execute D=testdb,t=person")
