...
assert buildLogText.contains("Executing: pt-online-schema-change --alter=\"DROP FOREIGN KEY _FK_2\"")
...
assert buildLogText.contains("Executing: pt-online-schema-change --alter=\"DROP FOREIGN KEY FK_1\"")
...
assert sqlText.contains("pt-online-schema-change --alter=\"DROP FOREIGN KEY _FK_2\"")
...
assert sqlText.contains("pt-online-schema-change --alter=\"DROP FOREIGN KEY _FK_1\"")
