...
assert buildLogText.contains("ChangeSet test-changelog.yaml::2::Alice ran successfully")
assert buildLogText.contains("Executing: pt-online-schema-change --alter-foreign-keys-method=drop_swap")
...
assert sqlText.contains("pt-online-schema-change --alter-foreign-keys-method=drop_swap")
