...
@DatabaseChange(name = PerconaDropUniqueConstraintChange.NAME, description = "Drops an existing unique constraint",
    priority = PerconaDropUniqueConstraintChange.PRIORITY, appliesTo = "table")
public class PerconaDropUniqueConstraintChange extends DropUniqueConstraintChange {
    ...
    public SqlStatement[] generateStatements(Database database) {
        return PerconaChangeUtil.generateStatements(PerconaDropUniqueConstraintChange.NAME,
                database,
