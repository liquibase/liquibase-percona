...
* Liquibase 5.0.4 (liquibase-percona 5.0.4). Percona Toolkit 3.7.1-4.
...
* Liquibase 4.33.0 (liquibase-percona 4.33.0). Percona Toolkit 3.7.0-2.
* Liquibase 5.0.1 (liquibase-percona 5.0.1). Percona Toolkit 3.7.0-2.
* Liquibase 5.0.2 (liquibase-percona 5.0.2). Percona Toolkit 3.7.1.
...
After extracting the zip file of liquibase, place `liquibase-percona-5.0.4.jar` file in the sub directory `lib`.
...
And just use the latest SNAPSHOT version for liquibase-percona dependency, e.g. `5.0.5-SNAPSHOT`:
