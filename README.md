...
After extracting the zip file of liquibase, place `liquibase-percona-5.0.2.jar` file in the sub directory `lib`.
...
And just use the latest SNAPSHOT version for liquibase-percona dependency, e.g. `5.0.3-SNAPSHOT`:
