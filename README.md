...
* Liquibase 4.0.0, 4.1.1, 4.2.2, 4.3.5, 4.4.3, 4.5.0, 4.6.2, 4.7.1, 4.8.0, 4.9.1, 4.10.0, 4.11.0, 4.12.0, 4.13.0 (liquibase-percona 4.13.0). Percona Toolkit 3.3.1.
...
After extracting the zip file of liquibase, place `liquibase-percona-4.13.0.jar` file in the sub directory `lib`.
...
And just use the latest SNAPSHOT version for liquibase-percona dependency, e.g. `4.13.1-SNAPSHOT`:
