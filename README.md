...
* Liquibase 4.0.0, 4.1.1, 4.2.2, 4.3.4 (liquibase-percona 4.3.4). Percona Toolkit 3.3.0.
...
And just use the latest SNAPSHOT version for liquibase-percona dependency, e.g. `4.3.5-SNAPSHOT`:
